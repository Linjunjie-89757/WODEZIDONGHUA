<template>
  <AppButton type="text" @click="open(env)">{{ t.common.edit }}</AppButton>
  <AppDialog
    v-model:visible="visible"
    :title="`${t.configCenter.envEditTitle} ${current?.envName || t.configCenter.envFallbackName}`"
...
import { useConfigEnvEdit } from '../model/useConfigEnvEdit';
...
const { visible, saving, current, form, open, submit } = useConfigEnvEdit();
