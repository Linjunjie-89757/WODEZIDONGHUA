<template>
  <AppButton type="primary" @click="open">{{ t.configCenter.dbCreate }}</AppButton>
  <AppDialog
    v-model:visible="visible"
    :title="t.configCenter.dbCreateTitle"
...
import { useConfigDbCreate } from '../model/useConfigDbCreate';

const emit = defineEmits<{
  success: [];
}>();

const { visible, saving, form, open, submit } = useConfigDbCreate();
