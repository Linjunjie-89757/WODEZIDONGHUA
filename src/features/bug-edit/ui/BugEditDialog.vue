<template>
  <AppButton type="text" :loading="loadingDetail" @click.stop="open(bug)">
    {{ t.common.edit }}
  </AppButton>
  <AppDialog
    v-model:visible="visible"
    :title="`${t.bugManagement.editTitle} ${current?.title || t.bugManagement.fallbackName}`"
...
import { useBugEdit } from '../model/useBugEdit';
